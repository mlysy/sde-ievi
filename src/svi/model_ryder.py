...
class Ryder:
    ...
    def __init__(self, n_state, obs_times, sde_times, x_init, obs_mat, scale = 1., restrict=False):
    ...
    def simulate(self, key, params, y_meas, theta):
        r"""
        ...
        def sim_step(carry, args):
            ...
            alpha = nn_output[:self._n_state] * self._scale
            beta_lower = jnp.zeros((self._n_state, self._n_state))
            beta_lower = beta_lower.at[lower_ind].set(nn_output[self._n_state:]) * self._scale
